...
sed -i 's/172.2.3.4/2pr/g' hvd16um_run_classifier.sh
sed -i 's/172.3.4.5/3pr/g' hvd16um_run_classifier.sh

# INSTANCE 1, c5n.18xlarge SERVER-PUBLIC-IP BELOW:
scp -i trialp32xlarge.pem id_rsa* ubuntu@1pu:/home/ubuntu/.ssh/
scp -i trialp32xlarge.pem hvd16um_run_classifier.sh ubuntu@1pu:/home/ubuntu/my_bert_tf1/
...
lxterminal -e ssh -t -i trialp32xlarge.pem ubuntu@1pu '. tf1/bin/activate; cd my_bert_tf1; bash hvd16um_run_classifier.sh; bash -l'

sed -i 's/2pr/172.2.3.4/g' hvd16um_run_classifier.sh
sed -i 's/3pr/172.3.4.5/g' hvd16um_run_classifier.sh
